							...
							<table class="bs-table" >
							  <tr>
	                     		...
	                     		<td colspan="2"> 
	                     			...
	                     			<img id="imgS" width="100" src="<%=path%>${goods.imgUrl}" style="width:120px;"/>
								...
								<tr>
									...
									<td><input class="form-control" name="name" type="text"
										value="${goods.name}" /></td>
									<td width="80">类别：</td>
									<td><k:dictSelect name="category.id" itemName="类别"
											className="form-control" value="${goods.category.id}" /></td>
								</tr>
								<tr>
									<td width="80">价格：</td>
